              ...
              <div className="flex">
                <div>
                  <input
                    ...
                    id="login"
                    className="border rounded-l-lg border-gray-300 text-gray-900 sm:text-sm focus:ring-primary-600 focus:border-primary-600 block w-full p-4"
              ...
              >
                <div className="relative p-4 w-full max-w-md max-h-full">
                  <div className="relative sm:w-[40rem] sm:h-[20rem] sm:ml-[-10rem] opacity-95 bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="p-4 md:p-5 flex justify-center mt-[1rem]">
                      <form
                        ...
                        <div className="bg-white flex ">
                          <div>
                            <input
                              ...
                              className="border border-gray-300 text-gray-900 sm:text-sm rounded-l-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-3"
                            />
                          </div>
                          <button
                            type="submit"
                            className="h-[3rem] flex text-black bg-yellow-400 hover:bg-yellow-300 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-r-lg text-sm px-5 py-2.5 text-center"
                          >
                            <MdLockOutline className="mr-2 text-[1.5rem]" />
                            <span className="inline-block mt-1">LOGIN</span>
                          </button>
